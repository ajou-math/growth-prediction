...
class BornChart4 extends StatefulWidget {
  BornChart4(
      {Key? key,
  ...
  @override
  State<BornChart4> createState() => _BornChart4State();
}

class _BornChart4State extends State<BornChart4> {
  int? age1;
  int? age2;
  int? age3;
  int? age4;
  ...
  void initState() {
    ...
    age4 = (int.parse(DateFormat('yy')
        ...
        (int.parse(widget.privJson[3]['privacybirth'].substring(0, 2))) +
        1;
  }
                    ...
                    data: [
                      {
                        ...
                        'data': [
                          ...
                          {
                            'domain':
                                '${DateFormat('yyMMM').format(DateTime.parse(widget.privJson[3]['privacyenterday']))}',
                            'measure': age4
                          },
                        ],
                      },
                      {
                        ...
                        'data': [
                          ...
                          },
                          {
                            'domain':
                                '${DateFormat('yyMMM').format(DateTime.parse(widget.privJson[3]['privacyenterday']))}',
                            'measure': widget.privJson[3]['privacybornage']
                          },
                        ],
                      },
                    ],
