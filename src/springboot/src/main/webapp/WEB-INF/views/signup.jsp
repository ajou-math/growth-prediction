...
<title>Sign Up</title>
<!-- css file -->
<link href="/springboot/css/signup.css" rel="stylesheet" type="text/css">
<!-- javascript file -->
<script src="/springboot/js/signup.js" type="text/javascript" ></script>
...
<main class ="contents">
	<div class = "main">
		<div class = "signup_box">
			<form action="/springboot/signup"  method = "post" class = "signup_form" id = "signup" autocomplete="off">
				<ul type = "none">
				<li><input type = "text" placeholder = "아이디 (영어 대소문자와 숫자를 포함해 10~20글자)" name = "doctorid" class = "signup_input" maxlength="20"></li>
